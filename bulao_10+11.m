...
e = 0.9;   % interference thresholds
b = 0.6;  % probability of harvesting

%% 循环
for t=0:1:T-1
    
    Aa = (sum(A==1))/L;  %A中物种的密度
    Ab = (sum(A==2))/L;
    Ac = (sum(A==3))/L;
   if Aa >= e   %若物种当前密度大于0.75，以一定的概率捕捞，原位置变为空
       for k=1:1:L
           if A(1,k)==1
                a=randsrc(1,1,[0 1;b 1-b]); 
                A(1,k)=a;
           else
                A(1,k)=A(1,k);
           end
...
xlim([0 T]);
ylim([0 1]);
ylabel({'\rho'},'FontWeight','bold','FontSize',14);  %x轴名称及字体和大小
...
y = 0.5:10000:T+0.5;
set(gca,'Ytick',y);
% set(gca,'yticklabel',{'800','600','400','200','0'}); %500
% set(gca,'yticklabel',{'2000','1600','1200','800','400','0'});  %1000
% set(gca,'yticklabel',{'1500','1200','900','600','300','0'}); %1500
